...
public class Usuario implements RegistroPersistente {
    ...
    public Usuario(int i, String n, String email, String senha, String perguntaSecreta, String respostaSecreta) {
        this.id = i;
        this.nome = n;
        this.email = email;
        this.senha = senha;
