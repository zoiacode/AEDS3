...
public class MenuUsuarios {
    ...
    public Usuario login() {
        ...
        try {
            ...
            Usuario c = arqClientes.read(email);
    ...
    public void recuperarSenha() {
        ...
        try {
            Usuario c = arqClientes.read(email.trim());
            if (c == null) {
    ...
    public void gerenciarDados(Usuario logado) {
        System.out.println("\n> Início > Meus Dados");
    ...
    public void buscarCliente() {
        ...
        try {
            Usuario cliente = arqClientes.read(email);  // Chama o método de leitura da classe Arquivo
            if (cliente != null) {
    ...
    public void incluirCliente() {
        ...
        if(resp=='S' || resp=='s') {
            try {
                ...
                Usuario c = new Usuario(id, nome, email, senhaHash, perguntaSecreta, respostaSecreta);
    ...
    public void alterarDadosLogado(Usuario logado) {
    ...
    public void excluirContaLogado(Usuario logado) {
        System.out.println("\nExclusão de cliente");
        ...
        try {
            ...
            Usuario cliente = arqClientes.read(emailString);
            if (cliente != null) {
    ...
    public void mostraCliente(Usuario cliente) {
    if (cliente != null) {
        System.out.println("\nDetalhes do Usuario:");
        System.out.println("----------------------");
